...
Router::connect('/directory', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'directory'));

Router::connect('/findUsers', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'findUsers'));
Router::connect('/setPassword/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'setPassword'));
