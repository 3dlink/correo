...
--
-- Servidor: localhost
-- Tiempo de generación: 20-02-2014 a las 18:44:57
...
(19, 13, 2, '2014-02-17 09:20:49'),
(20, 13, 17, '2014-02-17 09:19:58'),
(21, 14, 2, '2014-02-17 09:55:28'),
...
(46, 16, 21, 17, 2, 17, 3, 1, '2014-02-20 10:26:52', '2014-02-17 13:23:38', '2014-02-17 13:23:38', 0, 0, 0);
...
(2, 2, 'Desarrollador RIA', 'jehogo', '15adedee5071c72b61a2258023f33929', 'ec3afff348f4cdfe628775c18bbbaf7c', 'gouveia.horacio@gmail.com', 'Jesus Horacio', 'Gouveia', 1, 1, NULL, '2013-09-26 15:10:21', '2013-12-12 11:41:16', 3, 0, NULL, NULL, NULL, 1),
...
CREATE TABLE IF NOT EXISTS `user_circles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='contiene los usuarios que estan en un grupo' AUTO_INCREMENT=1 ;
