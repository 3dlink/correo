...
<div class="row">
	<div class="col-xs-12">
		<?php echo $this->Form->create('Circle', array('action' => 'add', 'class' => 'form-horizontal', 'role' => 'form')); ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 ">
				<select name="data[Circle][type]" class="col-xs-10 col-sm-5 s-entity">
					<option class="opt-entity" value="1">Privado</option>
					<option class="opt-entity" value="2">Público</option>
				</select>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9 ">
				<select name="data[Circle][active]" class="col-xs-10 col-sm-5 s-entity">
